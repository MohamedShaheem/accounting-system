...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Bank Transaction List</h1>
            </div>
        </div>
    </div>
</div>
...
<section class="content pb-3">
    <div class="container-fluid">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('bank-transaction.index') }}" method="GET">
                    <div class="row justify-content-center">
                        <div class="col-lg-11 col-xl-10">
                            <div class="form-row align-items-end justify-content-center">
                                ...
                                {{-- <div class="col-md-2">
                                    <label class="small font-weight-bold text-muted">Transaction</label>
                                ...
                                <div class="col-md-3">
                                    <label class="small font-weight-bold text-muted">Bank</label>
                                    <select class="form-control form-control-sm"
                                            name="bank_id">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Bank Transaction List</h3>
                <div class="card-tools">
                    <a href="{{ route('bank-transaction.create') }}" class="btn btn-success btn-sm">
                         Add New Transaction
                    </a>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="bankTransactionTable" class="table table-bordered table-striped">
                        <thead class="bg-dark">
                            <tr>
                                <th>Seq</th>
                                <th>Bank</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('bank-transaction.edit', $record['id']) }}" class="btn btn-sm btn-primary" title="Edit">
...
$(document).ready(function() {
    ...
    $('#removeFilter').click(function() {
        window.location.href = "{{ route('bank-transaction.index') }}";
    });
