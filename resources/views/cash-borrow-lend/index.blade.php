...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Cash Borrow/Lend Transaction List</h1>
            </div>
            <div class="col-sm-6">
                <div class="float-sm-right">
                    <a href="{{ route('cash-borrow-lend.overview') }}" class="btn btn-info">
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form action="{{ route('cash-borrow-lend.index') }}" method="GET">
                            ...
                            <div class="form-row align-items-end justify-content-center">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control form-control-sm"
                                        ...
                                        <option value="debit" {{ request('debit_credit')=='debit'?'selected':'' }}>
                                            Debit (Borrowed)
                                        </option>
                                        <option value="credit" {{ request('debit_credit')=='credit'?'selected':'' }}>
                                            Credit (Lent)
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control form-control-sm"
                                            name="cash_borrow_lend_account_id">
                                        <option value="">All Accounts</option>
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}"
                                                {{ request('cash_borrow_lend_account_id')==$account->id?'selected':'' }}>
                                                {{ $account->name }}
                                            </option>
                                        @endforeach
                                    </select>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Cash Borrow/Lend Transaction List</h3>
                <div class="card-tools">
                    <a href="{{ route('cash-borrow-lend.create') }}" class="btn btn-success btn-sm">
                         Add New Transaction
                    </a>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="cashBorrowLendTable" class="table table-bordered table-striped">
                        <thead class="bg-dark">
                            <tr>
                                <th>Seq</th>
                                <th>Account Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('cash-borrow-lend.edit', $record['id']) }}" class="btn btn-sm btn-primary" title="Edit">
...
$(document).ready(function() {
    ...
    $('#removeFilter').click(function() {
        window.location.href = "{{ route('cash-borrow-lend.index') }}";
    });
