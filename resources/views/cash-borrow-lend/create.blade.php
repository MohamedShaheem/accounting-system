...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Add Cash Borrow/Lend Transaction</h1>
            </div>
            <div class="col-sm-6">
...
<section class="content pb-3">
    <div class="container">
        <div class="card">
            ...
            <form action="{{ route('cash-borrow-lend.store') }}" method="POST" id="transactionForm">
                @csrf
                <div class="card-body">
                                    ...
                                    <select class="form-control @error('cash_borrow_lend_account_id') is-invalid @enderror" 
                                        ...
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" 
                                                {{ old('cash_borrow_lend_account_id') == $account->id ? 'selected' : '' }}
