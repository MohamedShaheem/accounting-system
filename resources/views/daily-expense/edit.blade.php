...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Daily Expense</h1>
            </div>
            <div class="col-sm-6">
...
<section class="content pb-3">
    <div class="container">
        <div class="card">
            ...
            <form action="{{ route('daily-expense.update', $expense->id) }}" method="POST" id="expenseForm">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                                ...
                                <select class="form-control select2 @error('expense_code_id') is-invalid @enderror" 
                                    ...
                                    @foreach($expenseCodes as $code)
                                        <option value="{{ $code->id }}" 
                                            {{ old('expense_code_id', $expense->expense_code_id) == $code->id ? 'selected' : '' }}>
                                            {{ $code->expense_code }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('expense_description') is-invalid @enderror" 
                                          ...
                                          rows="1" 
                                          placeholder="Enter expense description">{{ old('expense_description', $expense->expense_description) }}</textarea>
