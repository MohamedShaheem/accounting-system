...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Individual Accounts Overview</h1>
            </div>
            <div class="col-sm-6">
                <div class="float-sm-right">
                    ...
                    <a href="{{ route('individual-account.index') }}" class="btn btn-primary">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            ...
                            <div class="col-md-3">
                                <h6 class="text-muted">Total Receivable</h6>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Individual Accounts</h3>
                    </div>
                                ...
                                <tr>
                                    ...
                                    {{-- <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('individual-account.index', ['individual_account_id' => $account->id]) }}"
            ...
            <form id="accountForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <span class="invalid-feedback d-block" id="account_no-error"></span>
                    </div>
...
$(function () {
    ...
    $('.edit-account-btn').click(function () {
        let id = $(this).data('id');
        $.get("{{ url('individual-account-get') }}/" + id, res => {
            if (res.success) {
                $('#account_id').val(res.account.id);
                $('#name').val(res.account.name);
                $('#account_no').val(res.account.account_no);
    ...
    $('#accountForm').submit(function (e) {
        ...
        let url = method === 'PUT'
            ? "{{ url('individual-account-update') }}/" + id
            : "{{ route('individual-account-store') }}";
    ...
    $('.delete-account-btn').click(function () {
        ...
        Swal.fire({
            ...
            if (r.isConfirmed) {
                $.ajax({
                    url: "{{ url('individual-account-delete') }}/" + id,
                    type: 'DELETE',
